...
clock clk_mii_ref = XS1_CLKBLK_REF;
...
// FOR YOUR NETWORK
#define OWN_IP_ADDRESS { 192, 168, 1, 27}
...
void demo(chanend tx, chanend rx)
{
  ...
  while (1)
  {
    ...
    if (is_valid_arp_packet(rxbuf, nbytes))
      ...
      {
        printstr("received unknown ethernet packet\n");
      }
    ...
    {
      {
        ...
        phy_init(clk_smi, clk_mii_ref, p_mii_resetn, smi, mii);
